...
mem load -infile ../../software/mb_boot2/output/mb_boot2.sim -format hex /harness_logic_32_no_dram/ram/mem_array
#mem load -infile ../../software/mb_ultimate/output/ultimate.sim -format hex /harness_logic_32_no_dram/ram/mem_array
