...
with open("result/update.u2u", "rb") as f:
    vd1 = 0
    vd2 = 0
    address = 0x10000
    while True:
        ...
        # BRLID 101110   Rd  10100 Imm  1011 10RR RRRD AL00  => B9F4 => b9E4 to disable branch delay slot (doesn't fix the return + 8, so doesn't work)
