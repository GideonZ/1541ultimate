...
set_false_path -from {ddr2_ctrl:i_memphy|mem_io:i_phy|sys_reset_pipe[0]} -to {async_fifo_ft:\b_audio:i_aout|dcfifo:dcfifo_component|dcfifo_gpm1:auto_generated|dffpipe_3dc:rdaclr|dffe12a[0]}
set_false_path -from {ddr2_ctrl:i_memphy|mem_io:i_phy|sys_reset_pipe[0]} -to {async_fifo_ft:\b_audio:i_aout|dcfifo:dcfifo_component|dcfifo_gpm1:auto_generated|dffpipe_3dc:rdaclr|dffe13a[0]}
set_false_path -from {level_synchronizer:i_audio_reset|sync2} -to {async_fifo_ft:\b_audio:i_aout|dcfifo:dcfifo_component|dcfifo_gpm1:auto_generated|dffpipe_3dc:wraclr|dffe12a[0]}
set_false_path -from {level_synchronizer:i_audio_reset|sync2} -to {async_fifo_ft:\b_audio:i_aout|dcfifo:dcfifo_component|dcfifo_gpm1:auto_generated|dffpipe_3dc:wraclr|dffe13a[0]}
