# -------------------------------------------------------------------------
#
# ALTMEMPHY v15.1 DDR2 SDRAM pin constraints script for memphy
#
...
set_instance_assignment -name IO_STANDARD "${mem_dqs_n_IO_STANDARD}" -to ${mem_dqs_n_pin_name}${single_bit}
set_instance_assignment -name CURRENT_STRENGTH_NEW "${mem_dqs_n_CURRENT_STRENGTH_NEW}" -to ${mem_dqs_n_pin_name}${single_bit}
set_instance_assignment -name MEM_INTERFACE_DELAY_CHAIN_CONFIG "${delay_chain_config}" -to ${mem_dm_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dm_pin_name}${single_bit}
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dq_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dq_pin_name}[1]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dq_pin_name}[2]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dq_pin_name}[3]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dq_pin_name}[4]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dq_pin_name}[5]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dq_pin_name}[6]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dq_pin_name}[7]
set_instance_assignment -name MEM_INTERFACE_DELAY_CHAIN_CONFIG "${delay_chain_config}" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1077756020" -to ${mem_dqs_pin_name}${single_bit}
