...
| Field                      | Value                                                                                                                                                                                                                                              |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | f508be0260e5487731415667d241015695bf1d9b                                                                                                                                                                                                           |
| branch                     | agent/e2e-observability                                                                                                                                                                                                                            |
| worktree                   | dirty                                                                                                                                                                                                                                              |
| host                       | mickey                                                                                                                                                                                                                                             |
| python                     | 3.12.3                                                                                                                                                                                                                                             |
| started                    | 2026-08-14 12:12:09                                                                                                                                                                                                                                |
| duration                   | 3.682s                                                                                                                                                                                                                                             |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                   |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                   |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                       |
| command                    | `/tmp/e2e-observability-fixture/wrapper.py -j /tmp/e2e-observability-fixture/run --e2e --perf --syslog --syslog-port 35041 --record --record-fps 2 --recover-command rm -f /tmp/e2e-observability-fixture/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| 127.0.0.1           | perf    | a-benchmark          | 1       | OK         | 0.061s   | 0          | -                                                             |
...
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.659s   | 0          | -                                                             |
...
`FAIL` after 0.000s, at 2026-08-14 12:12:09, 00:02 into the recording, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 12:12:09, 00:02 into the recording, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 12:12:10, 00:02 into the recording, reported `the drive did not answer`.
...
`FAIL` after 0.000s, at 2026-08-14 12:12:11, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 12:12:11, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 12:12:12, reported `the drive did not answer`.
...
| broken                                | OK       | 13ms | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 11ms   | 2ms   |
...
| flaky                                 | OK       | 2ms  | 0ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| noisy                                 | OK       | 2ms  | 0ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| noisy: after failure,                 | OK       | 7ms  | 2ms  | 0ms  | 0ms    | 2ms   | 1ms | 1500000B | 6ms    | 2ms   |
...
| cut-short                             | OK       | 2ms  | 0ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| broken                                | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 5ms | 1500000B | 2ms    | 1ms   |
...
| noisy: after failure,                 | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 2ms    | 7ms   |
| browse                                | OK       | 2ms  | 2ms  | 3ms  | 0ms    | 1ms   | 1ms | 1500000B | 6ms    | 3ms   |
...
| menu-closed-again                     | OK       | 2ms  | 0ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | skip   | skip  |
...
| `run.jsonl`                                                  | 3907   | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
| `run.log`                                                    | 19246  | run-tests' own console output                                                                                   |
...
| `127.0.0.1/run.jsonl`                                        | 28149  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1/video.mp4`                                        | 137879 | the recording: the harness pane, the device's video and its audio                                               |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 24076  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
| `127.0.0.1-at-localhost/run.log`                             | 5031   | run-tests' own console output                                                                                   |
| `127.0.0.1-at-localhost/screens.jsonl`                       | 0      | every distinct screen the harness read, as text and as raw bytes                                                |
| `127.0.0.1-at-localhost/video.mp4`                           | 69728  | the recording: the harness pane, the device's video and its audio                                               |
...
+00:00  127.0.0.1 PUT /v1/streams/video:start {'ip': '127.0.0.1:40953'}
+00:00  127.0.0.1 PUT /v1/streams/audio:start {'ip': '127.0.0.1:58205'}
...
+00:02  127.0.0.1@localhost PUT /v1/streams/audio:start {'ip': '127.0.0.1:58205'}
+00:02  127.0.0.1@localhost GET /v1/machine:menu_screen -> 404: Menu screen unavailable.  (this request is made 20 times in this run and is shown twice)
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 12:12:09 | 2026-08-14 12:12:09 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 12:12:09 | 2026-08-14 12:12:09 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 12:12:09 | 2026-08-14 12:12:09 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 12:12:09 | 2026-08-14 12:12:09 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 12:12:09 | 2026-08-14 12:12:09 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.016s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.025s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-14 12:12:10 | 2026-08-14 12:12:10 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-14 12:12:11 | 2026-08-14 12:12:11 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 12:12:11 | 2026-08-14 12:12:11 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 12:12:11 | 2026-08-14 12:12:11 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 12:12:11 | 2026-08-14 12:12:11 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 12:12:11 | 2026-08-14 12:12:11 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 12:12:11 | 2026-08-14 12:12:11 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 12:12:12 | 2026-08-14 12:12:12 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 12:12:12 | 2026-08-14 12:12:12 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 12:12:12 | 2026-08-14 12:12:12 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 12:12:13 | 2026-08-14 12:12:13 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.022s   | 2026-08-14 12:12:13 | 2026-08-14 12:12:13 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 12:12:13 | 2026-08-14 12:12:13 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-14 12:12:13 | 2026-08-14 12:12:13 | -        |
...
| Suite run                                          | Duration |
| -------------------------------------------------- | -------- |
| 127.0.0.1@localhost/overlay/browse/1               | 0.659s   |
| 127.0.0.1/overlay/noisy/1                          | 0.205s   |
| 127.0.0.1@localhost/overlay/noisy/1                | 0.190s   |
| 127.0.0.1/overlay/browse/1                         | 0.117s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.103s   |
| 127.0.0.1/overlay/raised/1                         | 0.102s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.097s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.092s   |
| 127.0.0.1/perf/a-benchmark/1                       | 0.061s   |
| 127.0.0.1/overlay/held/1                           | 0.042s   |
