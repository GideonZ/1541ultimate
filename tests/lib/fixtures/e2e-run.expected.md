...
| Field                      | Value                                                                                                                                                                                                                                             |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | 4eee333709dd377a95cbfe6e74c7805931cdf470                                                                                                                                                                                                          |
| branch                     | feat/e2e-observability                                                                                                                                                                                                                            |
| worktree                   | dirty                                                                                                                                                                                                                                             |
| host                       | mickey                                                                                                                                                                                                                                            |
| python                     | 3.12.3                                                                                                                                                                                                                                            |
| started                    | 2026-08-15 15:39:03                                                                                                                                                                                                                               |
| duration                   | 4.362s                                                                                                                                                                                                                                            |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                  |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                  |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                      |
| command                    | `/tmp/e2e-observability-fixture-q816w89y/wrapper.py -o /tmp/e2e-observability-fixture-q816w89y/run --e2e --perf --syslog --syslog-port 0 --recover-command rm -f /tmp/e2e-observability-fixture-q816w89y/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 1.000s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.135s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-left-open       | 1       | OK         | 0.038s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-closed-again    | 1       | OK         | 0.038s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | leaves-things-behind | 1       | OK         | 0.099s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-q816w89y/suites/missing_file.py |
...
| 127.0.0.1@localhost | overlay | raised               | 1       | FAIL       | 0.104s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | flaky                | 1       | FAIL       | 0.036s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | flaky                | 2       | OK         | 0.042s   | 1          | -                                                                      |
| 127.0.0.1@localhost | overlay | noisy                | 1       | FAIL       | 1.004s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.658s   | 0          | -                                                                      |
...
| 127.0.0.1@localhost | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-q816w89y/suites/missing_file.py |
...
`FAIL` after 0.000s, at 2026-08-15 15:39:03, reported `0 rows, expected 20`.
...
Source: `/tmp/e2e-observability-fixture-q816w89y/suites/broken.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-15 15:39:03, reported `the listener is gone`.
...
Source: `/tmp/e2e-observability-fixture-q816w89y/suites/flaky.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.911s, at 2026-08-15 15:39:04, reported `the drive did not answer`.
...
Source: `/tmp/e2e-observability-fixture-q816w89y/suites/noisy.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-15 15:39:05, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-15 15:39:05, reported `the listener is gone`.
...
`FAIL` after 0.910s, at 2026-08-15 15:39:06, reported `the drive did not answer`.
...
[01] the device answers ... Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-q816w89y/suites/raised.py", line 18, in <module>
...
Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-q816w89y/suites/browse.py", line 20, in <module>
...
| browse                                | OK       | 4ms  | 1ms  | 1ms  | 0ms    | 1ms   | 0ms | 1500000B | 3ms    | 3ms   |
...
| `run.jsonl`                                                  | 4293  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
| `run.log`                                                    | 19704 | run-tests' own console output                                                                                                          |
| `syslog-unknown-sender.txt`                                  | 0     | log lines from an address no target in this run claimed, kept with the address that sent them                                          |
| `127.0.0.1/interactions.jsonl`                               | 65934 | every interaction the harness had with this device: each REST request and its answer, each Telnet exchange, each FTP command and reply |
...
| `127.0.0.1/run.jsonl`                                        | 25925 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
| `127.0.0.1/run.log`                                          | 6262  | run-tests' own console output                                                                                                          |
...
| `127.0.0.1-at-localhost/interactions.jsonl`                  | 67119 | every interaction the harness had with this device: each REST request and its answer, each Telnet exchange, each FTP command and reply |
...
| `127.0.0.1-at-localhost/overlay-leaves-things-behind.jsonl`  | 1014  | one suite run's checks, scenarios and device actions                                                                                   |
...
| `127.0.0.1-at-localhost/overlay-noisy.jsonl`                 | 244   | one suite run's checks, scenarios and device actions                                                                                   |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 23452 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
...
+00:01  127.0.0.1/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-q816w89y/suites/missing_file.py
...
+00:01  127.0.0.1 warning: device log: this device sends its log to port 5514 and this run collects on 57933, so none of it will arrive; set 'Log to Syslog Server' to '192.168.1.2:57933' and reboot the device (at the end of the run)
+00:02  127.0.0.1@localhost warning: device log: this device sends its log to port 5514 and this run collects on 57933, so none of it will arrive; set 'Log to Syslog Server' to '192.168.1.2:57933' and reboot the device (at the start of the run)
...
+00:04  127.0.0.1@localhost/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-q816w89y/suites/missing_file.py
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-15 15:39:03 | 2026-08-15 15:39:03 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-15 15:39:03 | 2026-08-15 15:39:03 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-15 15:39:03 | 2026-08-15 15:39:03 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-15 15:39:03 | 2026-08-15 15:39:03 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-15 15:39:03 | 2026-08-15 15:39:03 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-15 15:39:03 | 2026-08-15 15:39:03 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.911s   | 2026-08-15 15:39:03 | 2026-08-15 15:39:04 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.017s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.024s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:05 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.910s   | 2026-08-15 15:39:05 | 2026-08-15 15:39:06 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-15 15:39:07 | 2026-08-15 15:39:07 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-15 15:39:07 | 2026-08-15 15:39:07 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.023s   | 2026-08-15 15:39:07 | 2026-08-15 15:39:07 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-15 15:39:07 | 2026-08-15 15:39:07 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-15 15:39:07 | 2026-08-15 15:39:07 | -        |
...
| 127.0.0.1/overlay/noisy/1                          | 1.000s   |
| 127.0.0.1@localhost/overlay/browse/1               | 0.658s   |
| 127.0.0.1/overlay/browse/1                         | 0.135s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.104s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.099s   |
| 127.0.0.1/overlay/raised/1                         | 0.098s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.094s   |
| 127.0.0.1@localhost/overlay/flaky/2                | 0.042s   |
| 127.0.0.1/overlay/menu-left-open/1                 | 0.038s   |

Slowest checks:

| Check                                                | Label              | Duration |
| ---------------------------------------------------- | ------------------ | -------- |
| 127.0.0.1/overlay/noisy/1/1                          | the drive answers  | 0.911s   |
| 127.0.0.1@localhost/overlay/noisy/1/1                | the drive answers  | 0.910s   |
