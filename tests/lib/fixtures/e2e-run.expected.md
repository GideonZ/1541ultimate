...
| Field                      | Value                                                                                                                                                                                                                                                 |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | 53934d9865ae217927af2458375ec253ddcf933d                                                                                                                                                                                                              |
| branch                     | agent/mcm-stability-u2                                                                                                                                                                                                                                |
| worktree                   | dirty                                                                                                                                                                                                                                                 |
| host                       | mickey                                                                                                                                                                                                                                                |
| python                     | 3.12.3                                                                                                                                                                                                                                                |
| started                    | 2026-08-14 17:37:14                                                                                                                                                                                                                                   |
| duration                   | 2.785s                                                                                                                                                                                                                                                |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                          |
| command                    | `/tmp/e2e-observability-fixture-au9zfear/wrapper.py -o /tmp/e2e-observability-fixture-au9zfear/run --e2e --perf --syslog --syslog-port 48860 --recover-command rm -f /tmp/e2e-observability-fixture-au9zfear/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| ------------------- | ------- | -------------------- | ------- | ---------- | -------- | ---------- | ---------------------------------------------------------------------- |
| 127.0.0.1           | overlay | held                 | 1       | OK         | 0.034s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | broken               | 1       | FAIL       | 0.041s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | raised               | 1       | FAIL       | 0.114s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | flaky                | 1       | FAIL       | 0.039s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | flaky                | 2       | OK         | 0.040s   | 1          | -                                                                      |
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 0.189s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.130s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-left-open       | 1       | OK         | 0.043s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-closed-again    | 1       | OK         | 0.040s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | leaves-things-behind | 1       | OK         | 0.110s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-au9zfear/suites/missing_file.py |
| 127.0.0.1           | overlay | cut-short            | 1       | OK         | 0.037s   | 0          | -                                                                      |
...
| 127.0.0.1@localhost | overlay | noisy                | 1       | FAIL       | 0.190s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.653s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | menu-left-open       | 1       | OK         | 0.050s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | menu-closed-again    | 1       | OK         | 0.039s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | leaves-things-behind | 1       | OK         | 0.102s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-au9zfear/suites/missing_file.py |
...
`FAIL` after 0.000s, at 2026-08-14 17:37:14, reported `0 rows, expected 20`.
...
Source: `/tmp/e2e-observability-fixture-au9zfear/suites/broken.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 17:37:14, reported `the listener is gone`.
...
Source: `/tmp/e2e-observability-fixture-au9zfear/suites/flaky.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.100s, at 2026-08-14 17:37:14, reported `the drive did not answer`.
...
Source: `/tmp/e2e-observability-fixture-au9zfear/suites/noisy.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 17:37:15, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 17:37:15, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 17:37:15, reported `the drive did not answer`.
...
[01] the device answers ... Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-au9zfear/suites/raised.py", line 18, in <module>
...
Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-au9zfear/suites/browse.py", line 20, in <module>
    backend = ui_backend.make_backend('overlay', ARGS.host,
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/chris/dev/c64/1541u-mcm-stability/tests/e2e/lib/ui_backend.py", line 1959, in make_backend
    return RestBackend(host, password, timeout, interface_type=_MODE_INTERFACE_TYPE[mode])
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/chris/dev/c64/1541u-mcm-stability/tests/e2e/lib/ui_backend.py", line 1018, in __init__
...
| `run.jsonl`                                                  | 4021  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1/run.jsonl`                                        | 25612 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 23134 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
+00:01  127.0.0.1/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-au9zfear/suites/missing_file.py
...
+00:02  127.0.0.1@localhost/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-au9zfear/suites/missing_file.py
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.017s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 17:37:14 | 2026-08-14 17:37:14 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.028s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 17:37:15 | 2026-08-14 17:37:15 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 17:37:16 | 2026-08-14 17:37:16 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 17:37:16 | 2026-08-14 17:37:16 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.026s   | 2026-08-14 17:37:16 | 2026-08-14 17:37:16 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 17:37:16 | 2026-08-14 17:37:16 | -        |
...
| 127.0.0.1@localhost/overlay/noisy/1                | 0.190s   |
| 127.0.0.1/overlay/noisy/1                          | 0.189s   |
| 127.0.0.1/overlay/browse/1                         | 0.130s   |
| 127.0.0.1/overlay/raised/1                         | 0.114s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.110s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.109s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.102s   |
| 127.0.0.1@localhost/overlay/menu-left-open/1       | 0.050s   |
| 127.0.0.1/overlay/menu-left-open/1                 | 0.043s   |
...
| 127.0.0.1@localhost/overlay/leaves-things-behind/1/1 | the image mounts   | 0.026s   |
