...
| Field                      | Value                                                                                                                                                                                                                                             |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | 0a0dc7a1ac0fb742d45faa5a88b0920c311f1b39                                                                                                                                                                                                          |
| branch                     | feat/e2e-observability                                                                                                                                                                                                                            |
| worktree                   | dirty                                                                                                                                                                                                                                             |
| host                       | mickey                                                                                                                                                                                                                                            |
| python                     | 3.12.3                                                                                                                                                                                                                                            |
| started                    | 2026-08-15 15:57:03                                                                                                                                                                                                                               |
| duration                   | 4.388s                                                                                                                                                                                                                                            |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                  |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                  |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                      |
| command                    | `/tmp/e2e-observability-fixture-_ujs7yon/wrapper.py -o /tmp/e2e-observability-fixture-_ujs7yon/run --e2e --perf --syslog --syslog-port 0 --recover-command rm -f /tmp/e2e-observability-fixture-_ujs7yon/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 1.019s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.149s   | 0          | -                                                                      |
...
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-_ujs7yon/suites/missing_file.py |
| 127.0.0.1           | overlay | cut-short            | 1       | OK         | 0.031s   | 0          | -                                                                      |
| 127.0.0.1           | perf    | a-benchmark          | 1       | OK         | 0.031s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | held                 | 1       | OK         | 0.032s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | broken               | 1       | FAIL       | 0.031s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | raised               | 1       | FAIL       | 0.097s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | flaky                | 1       | FAIL       | 0.034s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | flaky                | 2       | OK         | 0.035s   | 1          | -                                                                      |
| 127.0.0.1@localhost | overlay | noisy                | 1       | FAIL       | 1.007s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.640s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | menu-left-open       | 1       | OK         | 0.035s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | menu-closed-again    | 1       | OK         | 0.034s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | leaves-things-behind | 1       | OK         | 0.093s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-_ujs7yon/suites/missing_file.py |
...
`FAIL` after 0.000s, at 2026-08-15 15:57:03, reported `0 rows, expected 20`.
...
Source: `/tmp/e2e-observability-fixture-_ujs7yon/suites/broken.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-15 15:57:03, reported `the listener is gone`.
...
Source: `/tmp/e2e-observability-fixture-_ujs7yon/suites/flaky.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.917s, at 2026-08-15 15:57:04, reported `the drive did not answer`.
...
Source: `/tmp/e2e-observability-fixture-_ujs7yon/suites/noisy.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-15 15:57:05, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-15 15:57:05, reported `the listener is gone`.
...
`FAIL` after 0.917s, at 2026-08-15 15:57:06, reported `the drive did not answer`.
...
[01] the device answers ... Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-_ujs7yon/suites/raised.py", line 18, in <module>
...
Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-_ujs7yon/suites/browse.py", line 20, in <module>
...
| noisy: after failure,                 | OK       | 9ms  | 3ms  | 1ms  | 1ms    | 3ms   | 1ms | 1500000B | 6ms    | 6ms   |
...
`syslog_failed_sends` stayed at 0 over 16 sweep(s), which counts datagrams the stack refused.
`syslog_overflows` stayed at 0 over 16 sweep(s), which counts times the forwarding buffer filled before it drained.
...
`syslog_failed_sends` stayed at 0 over 17 sweep(s), which counts datagrams the stack refused.
`syslog_overflows` stayed at 0 over 17 sweep(s), which counts times the forwarding buffer filled before it drained.
...
| `run.jsonl`                                                  | 4292  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
| `run.log`                                                    | 19690 | run-tests' own console output                                                                                                          |
| `syslog-unknown-sender.txt`                                  | 0     | log lines from an address no target in this run claimed, kept with the address that sent them                                          |
| `127.0.0.1/interactions.jsonl`                               | 66775 | every interaction the harness had with this device: each REST request and its answer, each Telnet exchange, each FTP command and reply |
...
| `127.0.0.1/overlay-noisy.jsonl`                              | 235   | one suite run's checks, scenarios and device actions                                                                                   |
...
| `127.0.0.1/run.jsonl`                                        | 26957 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
| `127.0.0.1/run.log`                                          | 6248  | run-tests' own console output                                                                                                          |
| `127.0.0.1/screens.jsonl`                                    | 10503 | every distinct screen the harness read, as text and as raw bytes                                                                       |
| `127.0.0.1/syslog.txt`                                       | 9356  | the device's own log, as the collector received it, best effort and incomplete by construction                                         |
| `127.0.0.1/transcript.txt`                                   | 22882 | the same interactions as one line each, sharing their sequence numbers with `interactions.jsonl`                                       |
...
| `127.0.0.1-at-localhost/interactions.jsonl`                  | 68026 | every interaction the harness had with this device: each REST request and its answer, each Telnet exchange, each FTP command and reply |
...
| `127.0.0.1-at-localhost/overlay-menu-closed-again.jsonl`     | 225   | one suite run's checks, scenarios and device actions                                                                                   |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 24560 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
| `127.0.0.1-at-localhost/run.log`                             | 5258  | run-tests' own console output                                                                                                          |
| `127.0.0.1-at-localhost/screens.jsonl`                       | 0     | every distinct screen the harness read, as text and as raw bytes                                                                       |
| `127.0.0.1-at-localhost/transcript.txt`                      | 22847 | the same interactions as one line each, sharing their sequence numbers with `interactions.jsonl`                                       |
...
+00:01  127.0.0.1/overlay/noisy/1/1 FAIL the drive answers
+00:01  127.0.0.1/overlay/noisy/1 FAIL
+00:01  127.0.0.1/overlay/noisy/1 device state captured
+00:01  127.0.0.1 sweep noisy: after failure,: OK
+00:01  127.0.0.1 sweep browse: OK
+00:01  127.0.0.1/overlay/browse/1 started
+00:01  127.0.0.1/overlay/browse/1 POST /v1/machine:input
+00:01  127.0.0.1/overlay/browse/1 OK
+00:01  127.0.0.1 sweep menu-left-open: OK
+00:01  127.0.0.1/overlay/menu-left-open/1 started
+00:01  127.0.0.1/overlay/menu-left-open/1 OK
+00:01  127.0.0.1 sweep menu-closed-again: OK
+00:01  127.0.0.1/overlay/menu-closed-again/1 started
...
+00:01  127.0.0.1/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-_ujs7yon/suites/missing_file.py
...
+00:01  127.0.0.1 warning: device log: this device sends its log to port 5514 and this run collects on 49273, so none of it will arrive; set 'Log to Syslog Server' to '192.168.1.2:49273' and reboot the device (at the end of the run)
+00:02  127.0.0.1@localhost warning: device log: this device sends its log to port 5514 and this run collects on 49273, so none of it will arrive; set 'Log to Syslog Server' to '192.168.1.2:49273' and reboot the device (at the start of the run)
+00:02  127.0.0.1@localhost GET /v1/machine:menu_screen -> 404: Menu screen unavailable.  (this request is made 18 times in this run and is shown twice)
...
+00:03  127.0.0.1@localhost/overlay/noisy/1/1 FAIL the drive answers
+00:03  127.0.0.1@localhost/overlay/noisy/1 FAIL
+00:03  127.0.0.1@localhost/overlay/noisy/1 device state captured
+00:03  127.0.0.1@localhost sweep noisy: after failure,: OK
+00:03  127.0.0.1@localhost sweep browse: OK
+00:03  127.0.0.1@localhost/overlay/browse/1 started
+00:03  127.0.0.1@localhost/overlay/browse/1 PUT /v1/machine:menu_button
+00:04  127.0.0.1@localhost/overlay/browse/1 FAIL
+00:04  127.0.0.1@localhost/overlay/browse/1 device state captured
+00:04  127.0.0.1@localhost sweep browse: after failure,: OK
+00:04  127.0.0.1@localhost sweep menu-left-open: OK
+00:04  127.0.0.1@localhost/overlay/menu-left-open/1 started
+00:04  127.0.0.1@localhost/overlay/menu-left-open/1 OK
+00:04  127.0.0.1@localhost sweep menu-closed-again: OK
+00:04  127.0.0.1@localhost/overlay/menu-closed-again/1 started
+00:04  127.0.0.1@localhost/overlay/menu-closed-again/1 OK
+00:04  127.0.0.1@localhost sweep leaves-things-behind: OK
+00:04  127.0.0.1@localhost/overlay/leaves-things-behind/1 started
+00:04  127.0.0.1@localhost/overlay/leaves-things-behind/1 PUT /v1/drives/a:mount {'image': '/Usb0/game.d64'}
+00:04  127.0.0.1@localhost/overlay/leaves-things-behind/1 PUT /v1/configs/Network%20Settings/Log%20to%20Syslog%20Server {'value': '192.168.1.2:5514'}
+00:04  127.0.0.1@localhost/overlay/leaves-things-behind/1 OK
+00:04  127.0.0.1@localhost/overlay/missing-file/1 started
+00:04  127.0.0.1@localhost/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-_ujs7yon/suites/missing_file.py
+00:04  127.0.0.1@localhost sweep cut-short: OK
+00:04  127.0.0.1@localhost/overlay/cut-short/1 started
+00:04  127.0.0.1@localhost/overlay/cut-short/1 incomplete
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-15 15:57:03 | 2026-08-15 15:57:03 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-15 15:57:03 | 2026-08-15 15:57:03 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-15 15:57:03 | 2026-08-15 15:57:03 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-15 15:57:03 | 2026-08-15 15:57:03 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-15 15:57:03 | 2026-08-15 15:57:03 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-15 15:57:03 | 2026-08-15 15:57:03 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.917s   | 2026-08-15 15:57:03 | 2026-08-15 15:57:04 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.017s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.023s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:05 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.917s   | 2026-08-15 15:57:05 | 2026-08-15 15:57:06 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-15 15:57:07 | 2026-08-15 15:57:07 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-15 15:57:07 | 2026-08-15 15:57:07 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.024s   | 2026-08-15 15:57:07 | 2026-08-15 15:57:07 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-15 15:57:07 | 2026-08-15 15:57:07 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-15 15:57:07 | 2026-08-15 15:57:07 | -        |
...
| Suite run                                          | Duration |
| -------------------------------------------------- | -------- |
| 127.0.0.1/overlay/noisy/1                          | 1.019s   |
| 127.0.0.1@localhost/overlay/noisy/1                | 1.007s   |
| 127.0.0.1@localhost/overlay/browse/1               | 0.640s   |
| 127.0.0.1/overlay/browse/1                         | 0.149s   |
| 127.0.0.1/overlay/raised/1                         | 0.098s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.097s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.095s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.093s   |
| 127.0.0.1/overlay/menu-left-open/1                 | 0.036s   |
| 127.0.0.1/overlay/menu-closed-again/1              | 0.036s   |

Slowest checks:

| Check                                                | Label              | Duration |
| ---------------------------------------------------- | ------------------ | -------- |
| 127.0.0.1@localhost/overlay/noisy/1/1                | the drive answers  | 0.917s   |
...
Each target's log was expected from the addresses its machines resolve to, and arrived from these:

| Target    | Expected from | Arrived from      |
| --------- | ------------- | ----------------- |
| 127.0.0.1 | -             | `127.0.0.1` (166) |

### 127.0.0.1

166 line(s) received, from `127.0.0.1/syslog.txt`.
