...
| Field                      | Value                                                                                                                                                                                                                                                 |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | cc180b6ab23968997edea027daf43213341efb88                                                                                                                                                                                                              |
| branch                     | agent/mcm-stability-u2                                                                                                                                                                                                                                |
| worktree                   | dirty                                                                                                                                                                                                                                                 |
| host                       | mickey                                                                                                                                                                                                                                                |
| python                     | 3.12.3                                                                                                                                                                                                                                                |
| started                    | 2026-08-14 18:00:05                                                                                                                                                                                                                                   |
| duration                   | 2.691s                                                                                                                                                                                                                                                |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                          |
| command                    | `/tmp/e2e-observability-fixture-9de5aohy/wrapper.py -o /tmp/e2e-observability-fixture-9de5aohy/run --e2e --perf --syslog --syslog-port 39177 --recover-command rm -f /tmp/e2e-observability-fixture-9de5aohy/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| 127.0.0.1           | overlay | menu-left-open       | 1       | OK         | 0.044s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-closed-again    | 1       | OK         | 0.036s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | leaves-things-behind | 1       | OK         | 0.098s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-9de5aohy/suites/missing_file.py |
...
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.650s   | 0          | -                                                                      |
...
| 127.0.0.1@localhost | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-9de5aohy/suites/missing_file.py |
...
`FAIL` after 0.000s, at 2026-08-14 18:00:05, reported `0 rows, expected 20`.
...
Source: `/tmp/e2e-observability-fixture-9de5aohy/suites/broken.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 18:00:05, reported `the listener is gone`.
...
Source: `/tmp/e2e-observability-fixture-9de5aohy/suites/flaky.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.100s, at 2026-08-14 18:00:05, reported `the drive did not answer`.
...
Source: `/tmp/e2e-observability-fixture-9de5aohy/suites/noisy.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 18:00:06, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 18:00:06, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 18:00:06, reported `the drive did not answer`.
...
[01] the device answers ... Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-9de5aohy/suites/raised.py", line 18, in <module>
...
Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-9de5aohy/suites/browse.py", line 20, in <module>
...
| menu-left-open                        | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| flaky                                 | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| noisy                                 | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| noisy: after failure,                 | OK       | 2ms  | 0ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| `run.jsonl`                                                  | 4020  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
+00:00  127.0.0.1/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-9de5aohy/suites/missing_file.py
...
+00:02  127.0.0.1@localhost/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-9de5aohy/suites/missing_file.py
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 18:00:05 | 2026-08-14 18:00:05 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 18:00:05 | 2026-08-14 18:00:05 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 18:00:05 | 2026-08-14 18:00:05 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 18:00:05 | 2026-08-14 18:00:05 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 18:00:05 | 2026-08-14 18:00:05 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 18:00:05 | 2026-08-14 18:00:05 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 18:00:05 | 2026-08-14 18:00:05 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.020s   | 2026-08-14 18:00:05 | 2026-08-14 18:00:06 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.024s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 18:00:06 | 2026-08-14 18:00:06 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 18:00:07 | 2026-08-14 18:00:07 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 18:00:07 | 2026-08-14 18:00:07 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.022s   | 2026-08-14 18:00:07 | 2026-08-14 18:00:07 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 18:00:07 | 2026-08-14 18:00:07 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-14 18:00:07 | 2026-08-14 18:00:07 | -        |
...
| Suite run                                          | Duration |
| -------------------------------------------------- | -------- |
| 127.0.0.1@localhost/overlay/browse/1               | 0.650s   |
...
| 127.0.0.1/overlay/menu-left-open/1                 | 0.044s   |
| 127.0.0.1@localhost/overlay/menu-left-open/1       | 0.043s   |
...
| 127.0.0.1/overlay/browse/1/1                         | the cursor moves   | 0.020s   |
