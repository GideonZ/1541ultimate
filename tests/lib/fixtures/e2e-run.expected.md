...
| Field                      | Value                                                                                                                                                                                                                                                 |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | 6f1a3d14d961ff4d29386cac4ce0653c9c6512cb                                                                                                                                                                                                              |
| branch                     | agent/mcm-stability-u2                                                                                                                                                                                                                                |
| worktree                   | dirty                                                                                                                                                                                                                                                 |
| host                       | mickey                                                                                                                                                                                                                                                |
| python                     | 3.12.3                                                                                                                                                                                                                                                |
| started                    | 2026-08-14 17:42:40                                                                                                                                                                                                                                   |
| duration                   | 3.028s                                                                                                                                                                                                                                                |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                          |
| command                    | `/tmp/e2e-observability-fixture-lad2gset/wrapper.py -o /tmp/e2e-observability-fixture-lad2gset/run --e2e --perf --syslog --syslog-port 58161 --recover-command rm -f /tmp/e2e-observability-fixture-lad2gset/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| 127.0.0.1           | overlay | raised               | 1       | FAIL       | 0.125s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | flaky                | 1       | FAIL       | 0.041s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | flaky                | 2       | OK         | 0.042s   | 1          | -                                                                      |
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 0.192s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.131s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-left-open       | 1       | OK         | 0.040s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-closed-again    | 1       | OK         | 0.038s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | leaves-things-behind | 1       | OK         | 0.117s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-lad2gset/suites/missing_file.py |
...
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.664s   | 0          | -                                                                      |
...
| 127.0.0.1@localhost | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-lad2gset/suites/missing_file.py |
...
`FAIL` after 0.000s, at 2026-08-14 17:42:40, reported `0 rows, expected 20`.
...
Source: `/tmp/e2e-observability-fixture-lad2gset/suites/broken.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 17:42:40, reported `the listener is gone`.
...
Source: `/tmp/e2e-observability-fixture-lad2gset/suites/flaky.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.100s, at 2026-08-14 17:42:40, reported `the drive did not answer`.
...
Source: `/tmp/e2e-observability-fixture-lad2gset/suites/noisy.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 17:42:41, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 17:42:41, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 17:42:41, reported `the drive did not answer`.
...
[01] the device answers ... Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-lad2gset/suites/raised.py", line 18, in <module>
...
Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-lad2gset/suites/browse.py", line 20, in <module>
...
| raised: after failure,                | OK       | 3ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| `syslog-unmapped.txt`                                        | 0     | the device's own log, as the collector received it, best effort and incomplete by construction                  |
...
| `127.0.0.1/run.jsonl`                                        | 25618 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 23137 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
+00:01  127.0.0.1/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-lad2gset/suites/missing_file.py
...
+00:02  127.0.0.1@localhost/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-lad2gset/suites/missing_file.py
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.018s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 17:42:40 | 2026-08-14 17:42:40 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.027s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 17:42:41 | 2026-08-14 17:42:41 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 17:42:42 | 2026-08-14 17:42:42 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 17:42:42 | 2026-08-14 17:42:42 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.028s   | 2026-08-14 17:42:42 | 2026-08-14 17:42:42 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 17:42:42 | 2026-08-14 17:42:42 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-14 17:42:42 | 2026-08-14 17:42:42 | -        |
...
| Suite run                                          | Duration |
| -------------------------------------------------- | -------- |
| 127.0.0.1@localhost/overlay/browse/1               | 0.664s   |
| 127.0.0.1@localhost/overlay/noisy/1                | 0.193s   |
| 127.0.0.1/overlay/noisy/1                          | 0.192s   |
| 127.0.0.1/overlay/browse/1                         | 0.131s   |
| 127.0.0.1/overlay/raised/1                         | 0.125s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.117s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.109s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.105s   |
| 127.0.0.1/overlay/flaky/2                          | 0.042s   |
| 127.0.0.1/overlay/flaky/1                          | 0.041s   |
...
| 127.0.0.1@localhost/overlay/leaves-things-behind/1/1 | the image mounts   | 0.028s   |
