...
| Field                      | Value                                                                                                                                                                                                                                             |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | ede36af8754b74ea1b1852c89f8e92d8bab78a4b                                                                                                                                                                                                          |
| branch                     | feat/e2e-observability                                                                                                                                                                                                                            |
| worktree                   | dirty                                                                                                                                                                                                                                             |
| host                       | mickey                                                                                                                                                                                                                                            |
| python                     | 3.12.3                                                                                                                                                                                                                                            |
| started                    | 2026-08-15 16:27:03                                                                                                                                                                                                                               |
| duration                   | 4.548s                                                                                                                                                                                                                                            |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                  |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                  |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                      |
| command                    | `/tmp/e2e-observability-fixture-81tpwxzq/wrapper.py -o /tmp/e2e-observability-fixture-81tpwxzq/run --e2e --perf --syslog --syslog-port 0 --recover-command rm -f /tmp/e2e-observability-fixture-81tpwxzq/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| ------------------- | ------- | -------------------- | ------- | ---------- | -------- | ---------- | ---------------------------------------------------------------------- |
| 127.0.0.1           | overlay | held                 | 1       | OK         | 0.030s   | 0          | -                                                                      |
...
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 1.001s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.116s   | 0          | -                                                                      |
...
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-81tpwxzq/suites/missing_file.py |
| 127.0.0.1           | overlay | cut-short            | 1       | OK         | 0.034s   | 0          | -                                                                      |
| 127.0.0.1           | perf    | a-benchmark          | 1       | OK         | 0.037s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | held                 | 1       | OK         | 0.033s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | broken               | 1       | FAIL       | 0.031s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | raised               | 1       | FAIL       | 0.096s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | flaky                | 1       | FAIL       | 0.035s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | flaky                | 2       | OK         | 0.034s   | 1          | -                                                                      |
| 127.0.0.1@localhost | overlay | noisy                | 1       | FAIL       | 1.018s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.694s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | menu-left-open       | 1       | OK         | 0.035s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | menu-closed-again    | 1       | OK         | 0.034s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | leaves-things-behind | 1       | OK         | 0.090s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-81tpwxzq/suites/missing_file.py |
...
`FAIL` after 0.000s, at 2026-08-15 16:27:03, reported `0 rows, expected 20`.
...
Source: `/tmp/e2e-observability-fixture-81tpwxzq/suites/broken.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-15 16:27:04, reported `the listener is gone`.
...
Source: `/tmp/e2e-observability-fixture-81tpwxzq/suites/flaky.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.916s, at 2026-08-15 16:27:05, reported `the drive did not answer`.
...
Source: `/tmp/e2e-observability-fixture-81tpwxzq/suites/noisy.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-15 16:27:05, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-15 16:27:06, reported `the listener is gone`.
...
`FAIL` after 0.917s, at 2026-08-15 16:27:07, reported `the drive did not answer`.
...
[01] the device answers ... Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-81tpwxzq/suites/raised.py", line 18, in <module>
...
Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-81tpwxzq/suites/browse.py", line 20, in <module>
...
| raised: after failure,                | OK       | 2ms  | 0ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| cut-short                             | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 2ms    | 2ms   |
...
| browse                                | OK       | 9ms  | 3ms  | 1ms  | 1ms    | 3ms   | 1ms | 1500000B | 6ms    | 6ms   |
...
| `run.jsonl`                                                  | 4291  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
...
| `127.0.0.1/interactions.jsonl`                               | 66784 | every interaction the harness had with this device: each REST request and its answer, each Telnet exchange, each FTP command and reply |
| `127.0.0.1/overlay-broken.jsonl`                             | 524   | one suite run's checks, scenarios and device actions                                                                                   |
...
| `127.0.0.1/run.jsonl`                                        | 26958 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
...
| `127.0.0.1-at-localhost/interactions.jsonl`                  | 68021 | every interaction the harness had with this device: each REST request and its answer, each Telnet exchange, each FTP command and reply |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 24555 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests                        |
...
+00:01  127.0.0.1/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-81tpwxzq/suites/missing_file.py
...
+00:01  127.0.0.1 warning: device log: this device sends its log to port 5514 and this run collects on 55938, so none of it will arrive; set 'Log to Syslog Server' to '192.168.1.2:55938' and reboot the device (at the end of the run)
+00:02  127.0.0.1@localhost warning: device log: this device sends its log to port 5514 and this run collects on 55938, so none of it will arrive; set 'Log to Syslog Server' to '192.168.1.2:55938' and reboot the device (at the start of the run)
...
+00:04  127.0.0.1@localhost/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-81tpwxzq/suites/missing_file.py
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-15 16:27:03 | 2026-08-15 16:27:03 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-15 16:27:03 | 2026-08-15 16:27:03 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-15 16:27:03 | 2026-08-15 16:27:03 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-15 16:27:03 | 2026-08-15 16:27:03 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-15 16:27:04 | 2026-08-15 16:27:04 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-15 16:27:04 | 2026-08-15 16:27:04 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.916s   | 2026-08-15 16:27:04 | 2026-08-15 16:27:05 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.017s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.023s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-15 16:27:05 | 2026-08-15 16:27:05 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-15 16:27:06 | 2026-08-15 16:27:06 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-15 16:27:06 | 2026-08-15 16:27:06 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.917s   | 2026-08-15 16:27:06 | 2026-08-15 16:27:07 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-15 16:27:08 | 2026-08-15 16:27:08 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-15 16:27:08 | 2026-08-15 16:27:08 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.022s   | 2026-08-15 16:27:08 | 2026-08-15 16:27:08 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-15 16:27:08 | 2026-08-15 16:27:08 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-15 16:27:08 | 2026-08-15 16:27:08 | -        |
...
| Suite run                                          | Duration |
| -------------------------------------------------- | -------- |
| 127.0.0.1@localhost/overlay/noisy/1                | 1.018s   |
| 127.0.0.1/overlay/noisy/1                          | 1.001s   |
| 127.0.0.1@localhost/overlay/browse/1               | 0.694s   |
| 127.0.0.1/overlay/browse/1                         | 0.116s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.096s   |
| 127.0.0.1/overlay/raised/1                         | 0.095s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.095s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.090s   |
| 127.0.0.1/perf/a-benchmark/1                       | 0.037s   |
...
| --------- | ------------- | ----------------- |
| 127.0.0.1 | `127.0.0.1`   | `127.0.0.1` (166) |
