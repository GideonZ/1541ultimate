...
| Field                      | Value                                                                                                                                                                                                                      |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | a3fc3563b5d66848b911b907bd3336f4f150610f                                                                                                                                                                                   |
| branch                     | agent/e2e-observability                                                                                                                                                                                                    |
| worktree                   | dirty                                                                                                                                                                                                                      |
| host                       | mickey                                                                                                                                                                                                                     |
| python                     | 3.12.3                                                                                                                                                                                                                     |
| started                    | 2026-08-14 09:33:12                                                                                                                                                                                                        |
| duration                   | 8.970s                                                                                                                                                                                                                     |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                           |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                           |
| exit status                | 1: at least one suite failed                                                                                                                                                                                               |
| command                    | `/tmp/e2e-observability-fixture/wrapper.py -j /tmp/e2e-observability-fixture/run --e2e --perf --syslog --syslog-port 48044 --recover-command rm -f /tmp/e2e-observability-fixture/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 0.186s   | 0          | -                                                             |
| 127.0.0.1           | screens | screens              | 1       | incomplete | -        | 0          | -                                                             |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.219s   | 0          | -                                                             |
...
| 127.0.0.1@localhost | overlay | held                 | 1       | OK         | 0.035s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | broken               | 1       | FAIL       | 0.032s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | raised               | 1       | FAIL       | 0.099s   | 0          | -                                                             |
...
`FAIL` after 0.000s, at 2026-08-14 09:33:12, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 09:33:12, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 09:33:12, reported `the drive did not answer`.
...
`FAIL` after 0.000s, at 2026-08-14 09:33:14, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 09:33:14, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 09:33:14, reported `the drive did not answer`.
...
| Sweep                                 | Verdict  | ping | rest | ftp  | telnet | ident | dma | heap     | raster | jiffy |
| ------------------------------------- | -------- | ---- | ---- | ---- | ------ | ----- | --- | -------- | ------ | ----- |
| held                                  | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| broken                                | OK       | 2ms  | 0ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| broken: after failure,                | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| `run.jsonl`                                                  | 3878  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1/overlay-held.jsonl`                               | 462   | one suite run's checks, scenarios and device actions                                                            |
...
| `127.0.0.1/run.jsonl`                                        | 25251 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 22992 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 09:33:12 | 2026-08-14 09:33:12 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 09:33:12 | 2026-08-14 09:33:12 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 09:33:12 | 2026-08-14 09:33:12 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 09:33:12 | 2026-08-14 09:33:12 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 09:33:12 | 2026-08-14 09:33:12 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 09:33:12 | 2026-08-14 09:33:12 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 09:33:12 | 2026-08-14 09:33:12 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.108s   | 2026-08-14 09:33:12 | 2026-08-14 09:33:13 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 09:33:13 | 2026-08-14 09:33:13 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 09:33:13 | 2026-08-14 09:33:13 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.024s   | 2026-08-14 09:33:13 | 2026-08-14 09:33:13 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 09:33:13 | 2026-08-14 09:33:13 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-14 09:33:13 | 2026-08-14 09:33:13 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-14 09:33:13 | 2026-08-14 09:33:13 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-14 09:33:13 | 2026-08-14 09:33:13 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 09:33:14 | 2026-08-14 09:33:14 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 09:33:14 | 2026-08-14 09:33:14 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 09:33:14 | 2026-08-14 09:33:14 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 09:33:14 | 2026-08-14 09:33:14 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 09:33:14 | 2026-08-14 09:33:14 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 09:33:14 | 2026-08-14 09:33:14 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 09:33:14 | 2026-08-14 09:33:14 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 09:33:20 | 2026-08-14 09:33:20 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 09:33:20 | 2026-08-14 09:33:20 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.032s   | 2026-08-14 09:33:20 | 2026-08-14 09:33:20 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 09:33:20 | 2026-08-14 09:33:20 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-14 09:33:20 | 2026-08-14 09:33:20 | -        |
...
| Suite run                                          | Duration |
| -------------------------------------------------- | -------- |
| 127.0.0.1@localhost/overlay/browse/1               | 6.187s   |
| 127.0.0.1/overlay/browse/1                         | 0.219s   |
| 127.0.0.1@localhost/overlay/noisy/1                | 0.190s   |
| 127.0.0.1/overlay/noisy/1                          | 0.186s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.111s   |
| 127.0.0.1/overlay/raised/1                         | 0.100s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.099s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.096s   |
| 127.0.0.1/overlay/menu-left-open/1                 | 0.044s   |
| 127.0.0.1@localhost/overlay/menu-left-open/1       | 0.038s   |

Slowest checks:

| Check                                                | Label              | Duration |
| ---------------------------------------------------- | ------------------ | -------- |
| 127.0.0.1/overlay/browse/1/1                         | the cursor moves   | 0.108s   |
| 127.0.0.1@localhost/overlay/noisy/1/1                | the drive answers  | 0.100s   |
| 127.0.0.1/overlay/noisy/1/1                          | the drive answers  | 0.100s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1/1 | the image mounts   | 0.032s   |
