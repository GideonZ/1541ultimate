...
| Field                      | Value                                                                                                                                                                                                                                                 |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | 2ed1210aa001b797018281c13a44c602aa9b5a0a                                                                                                                                                                                                              |
| branch                     | agent/mcm-stability-u2                                                                                                                                                                                                                                |
| worktree                   | dirty                                                                                                                                                                                                                                                 |
| host                       | mickey                                                                                                                                                                                                                                                |
| python                     | 3.12.3                                                                                                                                                                                                                                                |
| started                    | 2026-08-14 14:12:21                                                                                                                                                                                                                                   |
| duration                   | 3.654s                                                                                                                                                                                                                                                |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                          |
| command                    | `/tmp/e2e-observability-fixture-5jgkphta/wrapper.py -j /tmp/e2e-observability-fixture-5jgkphta/run --e2e --perf --syslog --syslog-port 43525 --recover-command rm -f /tmp/e2e-observability-fixture-5jgkphta/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| 127.0.0.1           | overlay | broken               | 1       | FAIL       | 0.048s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | raised               | 1       | FAIL       | 0.164s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | flaky                | 1       | FAIL       | 0.050s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | flaky                | 2       | OK         | 0.052s   | 1          | -                                                                      |
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 0.201s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.171s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-left-open       | 1       | OK         | 0.052s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | menu-closed-again    | 1       | OK         | 0.050s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | leaves-things-behind | 1       | OK         | 0.120s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-5jgkphta/suites/missing_file.py |
| 127.0.0.1           | overlay | cut-short            | 1       | OK         | 0.036s   | 0          | -                                                                      |
| 127.0.0.1           | perf    | a-benchmark          | 1       | OK         | 0.043s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | held                 | 1       | OK         | 0.036s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | broken               | 1       | FAIL       | 0.033s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | raised               | 1       | FAIL       | 0.114s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | flaky                | 1       | FAIL       | 0.038s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | flaky                | 2       | OK         | 0.039s   | 1          | -                                                                      |
| 127.0.0.1@localhost | overlay | noisy                | 1       | FAIL       | 0.191s   | 0          | -                                                                      |
...
| 127.0.0.1@localhost | overlay | leaves-things-behind | 1       | OK         | 0.101s   | 0          | -                                                                      |
| 127.0.0.1@localhost | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-5jgkphta/suites/missing_file.py |
...
`FAIL` after 0.000s, at 2026-08-14 14:12:22, reported `0 rows, expected 20`.
...
Source: `/tmp/e2e-observability-fixture-5jgkphta/suites/broken.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 14:12:22, reported `the listener is gone`.
...
Source: `/tmp/e2e-observability-fixture-5jgkphta/suites/flaky.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.100s, at 2026-08-14 14:12:22, reported `the drive did not answer`.
...
Source: `/tmp/e2e-observability-fixture-5jgkphta/suites/noisy.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 14:12:24, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 14:12:24, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 14:12:24, reported `the drive did not answer`.
...
[01] the device answers ... Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-5jgkphta/suites/raised.py", line 18, in <module>
...
Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-5jgkphta/suites/browse.py", line 20, in <module>
    backend = ui_backend.make_backend('overlay', ARGS.host,
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/chris/dev/c64/1541u-mcm-stability/tests/e2e/lib/ui_backend.py", line 1947, in make_backend
    return RestBackend(host, password, timeout, interface_type=_MODE_INTERFACE_TYPE[mode])
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/chris/dev/c64/1541u-mcm-stability/tests/e2e/lib/ui_backend.py", line 1006, in __init__
    close_host_menu(self.input_host, password, timeout)
  File "/home/chris/dev/c64/1541u-mcm-stability/tests/e2e/lib/ui_backend.py", line 174, in close_host_menu
    raise Failure(
...
| broken: after failure,                | OK       | 3ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 2ms    | 4ms   |
...
| flaky: after failure, after recovery, | OK       | 3ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 2ms    | 2ms   |
| flaky                                 | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| menu-left-open                        | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 2ms    | 1ms   |
| menu-closed-again                     | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | skip   | skip  |
| leaves-things-behind                  | OK       | 4ms  | 1ms  | 1ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| `run.jsonl`                                                  | 4019  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
| `run.log`                                                    | 19226 | run-tests' own console output                                                                                   |
...
| `127.0.0.1/run.jsonl`                                        | 25606 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 23127 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
+00:01  127.0.0.1/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-5jgkphta/suites/missing_file.py
...
+00:03  127.0.0.1@localhost/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-5jgkphta/suites/missing_file.py
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 14:12:22 | 2026-08-14 14:12:22 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 14:12:22 | 2026-08-14 14:12:22 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 14:12:22 | 2026-08-14 14:12:22 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 14:12:22 | 2026-08-14 14:12:22 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 14:12:22 | 2026-08-14 14:12:22 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 14:12:22 | 2026-08-14 14:12:22 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 14:12:22 | 2026-08-14 14:12:22 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.022s   | 2026-08-14 14:12:22 | 2026-08-14 14:12:22 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 14:12:23 | 2026-08-14 14:12:23 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 14:12:23 | 2026-08-14 14:12:23 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.028s   | 2026-08-14 14:12:23 | 2026-08-14 14:12:23 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 14:12:23 | 2026-08-14 14:12:23 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-14 14:12:23 | 2026-08-14 14:12:23 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-14 14:12:23 | 2026-08-14 14:12:23 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-14 14:12:23 | 2026-08-14 14:12:23 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 14:12:24 | 2026-08-14 14:12:24 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 14:12:24 | 2026-08-14 14:12:24 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 14:12:24 | 2026-08-14 14:12:24 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 14:12:24 | 2026-08-14 14:12:24 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 14:12:24 | 2026-08-14 14:12:24 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 14:12:24 | 2026-08-14 14:12:24 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 14:12:24 | 2026-08-14 14:12:24 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 14:12:25 | 2026-08-14 14:12:25 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 14:12:25 | 2026-08-14 14:12:25 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.024s   | 2026-08-14 14:12:25 | 2026-08-14 14:12:25 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 14:12:25 | 2026-08-14 14:12:25 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-14 14:12:25 | 2026-08-14 14:12:25 | -        |
...
| 127.0.0.1/overlay/noisy/1                          | 0.201s   |
| 127.0.0.1@localhost/overlay/noisy/1                | 0.191s   |
| 127.0.0.1/overlay/browse/1                         | 0.171s   |
| 127.0.0.1/overlay/raised/1                         | 0.164s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.120s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.114s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.101s   |
| 127.0.0.1/overlay/menu-left-open/1                 | 0.052s   |
| 127.0.0.1/overlay/flaky/2                          | 0.052s   |
...
| 127.0.0.1/overlay/leaves-things-behind/1/1           | the image mounts   | 0.028s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1/1 | the image mounts   | 0.024s   |
| 127.0.0.1/overlay/browse/1/1                         | the cursor moves   | 0.022s   |
