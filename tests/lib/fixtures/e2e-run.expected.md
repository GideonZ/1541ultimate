...
| Field                      | Value                                                                                                                                                                                                                                              |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | 000e07f8d2b0b96095b73a11ecf85e5dbb1aa0a4                                                                                                                                                                                                           |
| branch                     | agent/e2e-observability                                                                                                                                                                                                                            |
| worktree                   | dirty                                                                                                                                                                                                                                              |
| host                       | mickey                                                                                                                                                                                                                                             |
| python                     | 3.12.3                                                                                                                                                                                                                                             |
| started                    | 2026-08-14 10:23:26                                                                                                                                                                                                                                |
| duration                   | 4.068s                                                                                                                                                                                                                                             |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                   |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                   |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                       |
| command                    | `/tmp/e2e-observability-fixture/wrapper.py -j /tmp/e2e-observability-fixture/run --e2e --perf --syslog --syslog-port 54263 --record --record-fps 2 --recover-command rm -f /tmp/e2e-observability-fixture/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| ------------------- | ------- | -------------------- | ------- | ---------- | -------- | ---------- | ------------------------------------------------------------- |
| 127.0.0.1           | overlay | held                 | 1       | OK         | 0.045s   | 0          | -                                                             |
| 127.0.0.1           | overlay | broken               | 1       | FAIL       | 0.035s   | 0          | -                                                             |
| 127.0.0.1           | overlay | raised               | 1       | FAIL       | 0.122s   | 0          | -                                                             |
| 127.0.0.1           | overlay | flaky                | 1       | FAIL       | 0.044s   | 0          | -                                                             |
| 127.0.0.1           | overlay | flaky                | 2       | OK         | 0.044s   | 1          | -                                                             |
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 0.194s   | 0          | -                                                             |
| 127.0.0.1           | screens | screens              | 1       | incomplete | -        | 0          | -                                                             |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.126s   | 0          | -                                                             |
| 127.0.0.1           | overlay | menu-left-open       | 1       | OK         | 0.038s   | 0          | -                                                             |
| 127.0.0.1           | overlay | menu-closed-again    | 1       | OK         | 0.040s   | 0          | -                                                             |
| 127.0.0.1           | overlay | leaves-things-behind | 1       | OK         | 0.112s   | 0          | -                                                             |
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture/suites/missing_file.py |
| 127.0.0.1           | overlay | cut-short            | 1       | OK         | 0.045s   | 0          | -                                                             |
| 127.0.0.1           | perf    | a-benchmark          | 1       | OK         | 0.035s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | held                 | 1       | OK         | 0.049s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | broken               | 1       | FAIL       | 0.037s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | raised               | 1       | FAIL       | 0.127s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | flaky                | 1       | FAIL       | 0.043s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | flaky                | 2       | OK         | 0.040s   | 1          | -                                                             |
| 127.0.0.1@localhost | overlay | noisy                | 1       | FAIL       | 0.187s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.710s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | menu-left-open       | 1       | OK         | 0.064s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | menu-closed-again    | 1       | OK         | 0.052s   | 0          | -                                                             |
| 127.0.0.1@localhost | overlay | leaves-things-behind | 1       | OK         | 0.157s   | 0          | -                                                             |
...
`FAIL` after 0.000s, at 2026-08-14 10:23:27, 00:02 into the recording, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 10:23:27, 00:02 into the recording, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 10:23:27, 00:02 into the recording, reported `the drive did not answer`.
...
`FAIL` after 0.000s, at 2026-08-14 10:23:29, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 10:23:29, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 10:23:29, reported `the drive did not answer`.
...
| broken                                | OK       | 12ms | 15ms | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 17ms   | 1ms   |
| broken: after failure,                | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 2ms    | 2ms   |
| raised                                | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| leaves-things-behind                  | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| broken                                | OK       | 22ms | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| broken: after failure,                | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
| raised                                | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 2ms   |
| raised: after failure,                | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
| flaky                                 | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| flaky: after failure,                 | DEGRADED | 3ms  | 1ms  | FAIL | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
| flaky: after failure, after recovery, | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| flaky                                 | OK       | 4ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| noisy                                 | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| noisy: after failure,                 | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| browse                                | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | 1ms    | 1ms   |
| browse: after failure,                | OK       | 4ms  | 2ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | skip   | skip  |
| menu-left-open                        | OK       | 3ms  | 1ms  | 0ms  | 0ms    | 1ms   | 0ms | 1500000B | skip   | skip  |
...
| cut-short                             | OK       | 4ms  | 1ms  | 1ms  | 0ms    | 2ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| `run.jsonl`                                                  | 3908   | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1/overlay-leaves-things-behind.jsonl`               | 973    | one suite run's checks, scenarios and device actions                                                            |
...
| `127.0.0.1/run.jsonl`                                        | 28055  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
| `127.0.0.1/run.log`                                          | 6061   | run-tests' own console output                                                                                   |
...
| `127.0.0.1/video.mp4`                                        | 129842 | the recording: the harness pane, the device's video and its audio                                               |
...
| `127.0.0.1/capture/overlay-flaky-2-1-first.png`              | 2653   | a still from the recording                                                                                      |
| `127.0.0.1/capture/overlay-flaky-2-1-first.txt`              | 16     | part of this run                                                                                                |
| `127.0.0.1/capture/overlay-held-1-1-first.png`               | 2913   | a still from the recording                                                                                      |
| `127.0.0.1/capture/overlay-held-1-1-first.txt`               | 16     | part of this run                                                                                                |
| `127.0.0.1/capture/overlay-noisy-1-1-first.png`              | 3778   | a still from the recording                                                                                      |
...
| `127.0.0.1/capture/perf-a-benchmark-1-1-first.png`           | 3936   | a still from the recording                                                                                      |
| `127.0.0.1/capture/perf-a-benchmark-1-1-first.txt`           | 1025   | part of this run                                                                                                |
| `127.0.0.1-at-localhost/audio.m4a`                           | 23537  | part of this run                                                                                                |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 24474  | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1-at-localhost/video.mp4`                           | 90761  | the recording: the harness pane, the device's video and its audio                                               |
...
| `127.0.0.1-at-localhost/capture/overlay-flaky-2-1-first.png` | 2745   | a still from the recording                                                                                      |
| `127.0.0.1-at-localhost/capture/overlay-flaky-2-1-first.txt` | 16     | part of this run                                                                                                |
| `127.0.0.1-at-localhost/capture/overlay-held-1-1-first.png`  | 2939   | a still from the recording                                                                                      |
| `127.0.0.1-at-localhost/capture/overlay-held-1-1-first.txt`  | 16     | part of this run                                                                                                |
| `127.0.0.1-at-localhost/capture/overlay-noisy-1-1-first.png` | 2792   | a still from the recording                                                                                      |
...
+00:00  127.0.0.1 PUT /v1/streams/video:start {'ip': '127.0.0.1:44165'} -> 404: {"errors":["no such route"]}
+00:00  127.0.0.1 PUT /v1/streams/audio:start {'ip': '127.0.0.1:46552'} -> 404: {"errors":["no such route"]}
...
+00:02  127.0.0.1@localhost PUT /v1/streams/video:start {'ip': '127.0.0.1:44165'} -> 404: {"errors":["no such route"]}
+00:02  127.0.0.1@localhost PUT /v1/streams/audio:start {'ip': '127.0.0.1:46552'} -> 404: {"errors":["no such route"]}
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.017s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.026s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 10:23:27 | 2026-08-14 10:23:27 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-14 10:23:28 | 2026-08-14 10:23:28 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-14 10:23:28 | 2026-08-14 10:23:28 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-14 10:23:28 | 2026-08-14 10:23:28 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 10:23:29 | 2026-08-14 10:23:29 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 10:23:29 | 2026-08-14 10:23:29 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 10:23:29 | 2026-08-14 10:23:29 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 10:23:29 | 2026-08-14 10:23:29 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 10:23:29 | 2026-08-14 10:23:29 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 10:23:29 | 2026-08-14 10:23:29 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 10:23:29 | 2026-08-14 10:23:29 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 10:23:30 | 2026-08-14 10:23:30 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 10:23:30 | 2026-08-14 10:23:30 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.039s   | 2026-08-14 10:23:30 | 2026-08-14 10:23:30 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 10:23:30 | 2026-08-14 10:23:30 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-14 10:23:30 | 2026-08-14 10:23:30 | -        |
...
| Suite run                                          | Duration |
| -------------------------------------------------- | -------- |
| 127.0.0.1@localhost/overlay/browse/1               | 0.710s   |
| 127.0.0.1/overlay/noisy/1                          | 0.194s   |
| 127.0.0.1@localhost/overlay/noisy/1                | 0.187s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.157s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.127s   |
| 127.0.0.1/overlay/browse/1                         | 0.126s   |
| 127.0.0.1/overlay/raised/1                         | 0.122s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.112s   |
| 127.0.0.1@localhost/overlay/menu-left-open/1       | 0.064s   |
| 127.0.0.1@localhost/overlay/menu-closed-again/1    | 0.052s   |
...
| 127.0.0.1@localhost/overlay/leaves-things-behind/1/1 | the image mounts   | 0.039s   |
