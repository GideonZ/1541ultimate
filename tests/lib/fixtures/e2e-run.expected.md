...
| Field                      | Value                                                                                                                                                                                                                                                 |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commit                     | 499ae0c9dce33ce8c3ade04ed1af616e5db72501                                                                                                                                                                                                              |
| branch                     | agent/mcm-stability-u2                                                                                                                                                                                                                                |
| worktree                   | dirty                                                                                                                                                                                                                                                 |
| host                       | mickey                                                                                                                                                                                                                                                |
| python                     | 3.12.3                                                                                                                                                                                                                                                |
| started                    | 2026-08-14 19:45:37                                                                                                                                                                                                                                   |
| duration                   | 2.668s                                                                                                                                                                                                                                                |
| device 127.0.0.1           | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| device 127.0.0.1@localhost | Ultimate 64 3.15                                                                                                                                                                                                                                      |
| exit status                | 1: at least one suite failed                                                                                                                                                                                                                          |
| command                    | `/tmp/e2e-observability-fixture-xups0rw6/wrapper.py -o /tmp/e2e-observability-fixture-xups0rw6/run --e2e --perf --syslog --syslog-port 58710 --recover-command rm -f /tmp/e2e-observability-fixture-xups0rw6/unhealthy 127.0.0.1 127.0.0.1@localhost` |
...
| 127.0.0.1           | overlay | raised               | 1       | FAIL       | 0.099s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | flaky                | 1       | FAIL       | 0.038s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | flaky                | 2       | OK         | 0.036s   | 1          | -                                                                      |
| 127.0.0.1           | overlay | noisy                | 1       | FAIL       | 0.191s   | 0          | -                                                                      |
| 127.0.0.1           | overlay | browse               | 1       | OK         | 0.124s   | 0          | -                                                                      |
...
| 127.0.0.1           | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-xups0rw6/suites/missing_file.py |
...
| 127.0.0.1@localhost | overlay | browse               | 1       | FAIL       | 0.654s   | 0          | -                                                                      |
...
| 127.0.0.1@localhost | overlay | missing-file         | 1       | SKIP       | 0.000s   | 0          | missing /tmp/e2e-observability-fixture-xups0rw6/suites/missing_file.py |
...
`FAIL` after 0.000s, at 2026-08-14 19:45:37, reported `0 rows, expected 20`.
...
Source: `/tmp/e2e-observability-fixture-xups0rw6/suites/broken.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 19:45:37, reported `the listener is gone`.
...
Source: `/tmp/e2e-observability-fixture-xups0rw6/suites/flaky.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.100s, at 2026-08-14 19:45:37, reported `the drive did not answer`.
...
Source: `/tmp/e2e-observability-fixture-xups0rw6/suites/noisy.py`, which carries the check's label as a literal string.
...
`FAIL` after 0.000s, at 2026-08-14 19:45:38, reported `0 rows, expected 20`.
...
`FAIL` after 0.000s, at 2026-08-14 19:45:38, reported `the listener is gone`.
...
`FAIL` after 0.100s, at 2026-08-14 19:45:38, reported `the drive did not answer`.
...
[01] the device answers ... Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-xups0rw6/suites/raised.py", line 18, in <module>
...
Traceback (most recent call last):
  File "/tmp/e2e-observability-fixture-xups0rw6/suites/browse.py", line 20, in <module>
...
| flaky: after failure, after recovery, | OK       | 1ms  | 0ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
...
| flaky                                 | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 1ms    | 1ms   |
| noisy                                 | OK       | 2ms  | 1ms  | 0ms  | 0ms    | 0ms   | 0ms | 1500000B | 2ms    | 1ms   |
...
| `syslog-unmapped.txt`                                        | 0     | log lines from an address no target in this run claimed, kept with the address that sent them                   |
...
| `127.0.0.1/run.jsonl`                                        | 25614 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
| `127.0.0.1-at-localhost/run.jsonl`                           | 23125 | the run's own records: the plan, the health sweeps, the suite verdicts and the run result, written by run-tests |
...
+00:00  127.0.0.1/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-xups0rw6/suites/missing_file.py
...
+00:02  127.0.0.1@localhost/overlay/missing-file/1 SKIP: missing /tmp/e2e-observability-fixture-xups0rw6/suites/missing_file.py
...
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 19:45:37 | 2026-08-14 19:45:37 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 19:45:37 | 2026-08-14 19:45:37 | -        |

### 127.0.0.1/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 19:45:37 | 2026-08-14 19:45:37 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 19:45:37 | 2026-08-14 19:45:37 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 19:45:37 | 2026-08-14 19:45:37 | the listener is gone |

### 127.0.0.1/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 19:45:37 | 2026-08-14 19:45:37 | recovered |

### 127.0.0.1/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 19:45:37 | 2026-08-14 19:45:37 | the drive did not answer |

### 127.0.0.1/overlay/browse/1

| # | Check            | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ---------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the cursor moves | OK      | 0.018s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | one row  |

### 127.0.0.1/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | on screen |

### 127.0.0.1/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | -        |

### 127.0.0.1/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.023s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | -        |

### 127.0.0.1/overlay/cut-short/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half  | OK      | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | -        |
| 2 | the second half | OK      | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | -        |

### 127.0.0.1/perf/a-benchmark/1

| # | Check                    | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ------------------------ | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | typing reaches the field | OK      | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | 11.2 characters a second |
...
| # | Check                       | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the listing is complete     | OK      | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | 20 rows  |
| 2 | the first row is the header | OK      | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | -        |

### 127.0.0.1@localhost/overlay/broken/1

| # | Check                      | Verdict | Duration | Opened at           | Closed at           | Reported                                                                |
| - | -------------------------- | ------- | -------- | ------------------- | ------------------- | ----------------------------------------------------------------------- |
| 1 | the row survives a redraw  | FAIL    | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | 0 rows, expected 20                                                     |
| 2 | the name is listed in full | SKIP    | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | needs the ftp-listing-full-length fix, which this machine does not have |

### 127.0.0.1@localhost/overlay/flaky/1

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported             |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | -------------------- |
| 1 | the device is well | FAIL    | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | the listener is gone |

### 127.0.0.1@localhost/overlay/flaky/2

| # | Check              | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | ------------------ | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the device is well | OK      | 0.000s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | recovered |

### 127.0.0.1@localhost/overlay/noisy/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported                 |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | ------------------------ |
| 1 | the drive answers | FAIL    | 0.100s   | 2026-08-14 19:45:38 | 2026-08-14 19:45:38 | the drive did not answer |

### 127.0.0.1@localhost/overlay/menu-left-open/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported  |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | --------- |
| 1 | the menu opens | OK      | 0.000s   | 2026-08-14 19:45:39 | 2026-08-14 19:45:39 | on screen |

### 127.0.0.1@localhost/overlay/menu-closed-again/1

| # | Check           | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | --------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the menu closes | OK      | 0.000s   | 2026-08-14 19:45:39 | 2026-08-14 19:45:39 | -        |

### 127.0.0.1@localhost/overlay/leaves-things-behind/1

| # | Check             | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | ----------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the image mounts  | OK      | 0.023s   | 2026-08-14 19:45:39 | 2026-08-14 19:45:39 | -        |
| 2 | the setting takes | OK      | 0.001s   | 2026-08-14 19:45:39 | 2026-08-14 19:45:39 | -        |

### 127.0.0.1@localhost/overlay/cut-short/1

| # | Check          | Verdict | Duration | Opened at           | Closed at           | Reported |
| - | -------------- | ------- | -------- | ------------------- | ------------------- | -------- |
| 1 | the first half | OK      | 0.000s   | 2026-08-14 19:45:39 | 2026-08-14 19:45:39 | -        |
...
| Suite run                                          | Duration |
| -------------------------------------------------- | -------- |
| 127.0.0.1@localhost/overlay/browse/1               | 0.654s   |
| 127.0.0.1@localhost/overlay/noisy/1                | 0.196s   |
| 127.0.0.1/overlay/noisy/1                          | 0.191s   |
| 127.0.0.1/overlay/browse/1                         | 0.124s   |
| 127.0.0.1@localhost/overlay/raised/1               | 0.105s   |
| 127.0.0.1/overlay/raised/1                         | 0.099s   |
| 127.0.0.1/overlay/leaves-things-behind/1           | 0.098s   |
| 127.0.0.1@localhost/overlay/leaves-things-behind/1 | 0.097s   |
| 127.0.0.1@localhost/overlay/menu-closed-again/1    | 0.042s   |
| 127.0.0.1/overlay/menu-closed-again/1              | 0.040s   |
