...
-- Module  Version: 5.7
--/usr/local/diamond/3.12/ispfpga/bin/lin64/scuba -w -n pll2 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 100 -fclkop 50 -fclkop_tol 1.0 -phasep 0 -fclkos 100 -fclkos_tol 1.0 -phases 0 -phase_cntl STATIC -lock -fb_mode 9 -fdc /home/gideon/proj/ultimate/fpga/lattice/pll2/pll2.fdc 
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS2_DIV=>  1, CLKOS_DIV=>  6, CLKOP_DIV=>  12, CLKFB_DIV=>  1, 
        CLKI_DIV=>  2, FEEDBK_PATH=> "USERCLOCK")
        port map (CLKI=>CLKI, CLKFB=>CLKFB, PHASESEL1=>scuba_vlo, 
