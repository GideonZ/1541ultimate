...
-- Module  Version: 5.7
--/usr/local/diamond/3.12/ispfpga/bin/lin64/scuba -w -n pll1 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 50 -clkibuf LVCMOS18 -fclkop 50 -fclkop_tol 2.0 -fclkos 24 -fclkos_tol 2.0 -phases 0 -fclkos2 12.288 -fclkos2_tol 2.0 -phases2 0 -phase_cntl STATIC -lock -fb_mode 1 -fdc /home/gideon/proj/ultimate/neorv32/lattice/pll1/pll1.fdc 
...
architecture Structure of pll1 is
    ...
    --attribute IO_TYPE of Inst1_IB : label is "LVCMOS18";
...
--        port map (I=>CLKI, O=>buf_CLKI);
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS2_DIV=>  49, CLKOS_DIV=>  25, CLKOP_DIV=>  12, CLKFB_DIV=>  1, 
