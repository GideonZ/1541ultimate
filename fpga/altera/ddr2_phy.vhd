-- megafunction wizard: %altmemphy v14.1%
-- GENERATION: XML
...
-- ============================================================
-- Generated by altmemphy 14.1 [Altera, IP Toolbench 1.3.0 Build 190]
-- ************************************************************
...
ENTITY ddr2_phy IS
	PORT (
		...
		ctl_dqs_burst	: IN STD_LOGIC_VECTOR (0 DOWNTO 0);
		ctl_wdata_valid	: IN STD_LOGIC_VECTOR (0 DOWNTO 0);
		ctl_wdata	: IN STD_LOGIC_VECTOR (15 DOWNTO 0);
		ctl_dm	: IN STD_LOGIC_VECTOR (1 DOWNTO 0);
		ctl_addr	: IN STD_LOGIC_VECTOR (13 DOWNTO 0);
		...
		ctl_doing_rd	: IN STD_LOGIC_VECTOR (0 DOWNTO 0);
		...
		ctl_rdata	: OUT STD_LOGIC_VECTOR (15 DOWNTO 0);
...
-- Retrieval info: <MEGACORE title="ALTMEMPHY"  version="14.1"  build="198"  iptb_version="1.3.0 Build 190"  format_version="120" >
...
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/gideon/proj/ultimate/fpga/altera/ddr2_phy_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
