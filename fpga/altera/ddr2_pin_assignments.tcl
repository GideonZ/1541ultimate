# -------------------------------------------------------------------------
#
# ALTMEMPHY v14.1 DDR2 SDRAM pin constraints script for ddr2
#
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name MEM_INTERFACE_DELAY_CHAIN_CONFIG "${delay_chain_config}" -to ${mem_dm_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dm_pin_name}${single_bit}
