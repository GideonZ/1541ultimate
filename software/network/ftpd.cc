...
struct ftpd_command ftpd_commands[] = { "USER", &FTPDaemonThread::cmd_user, "PASS", &FTPDaemonThread::cmd_pass, "PORT",
        &FTPDaemonThread::cmd_port, "QUIT", &FTPDaemonThread::cmd_quit, "CWD", &FTPDaemonThread::cmd_cwd, "CDUP",
        &FTPDaemonThread::cmd_cdup, "PWD", &FTPDaemonThread::cmd_pwd, "XPWD", &FTPDaemonThread::cmd_pwd, "NLST",
        &FTPDaemonThread::cmd_nlst, "LIST", &FTPDaemonThread::cmd_list, "RETR", &FTPDaemonThread::cmd_retr, "STOR",
        &FTPDaemonThread::cmd_stor, "NOOP", &FTPDaemonThread::cmd_noop, "SYST", &FTPDaemonThread::cmd_syst, "ABOR",
        &FTPDaemonThread::cmd_abrt, "TYPE", &FTPDaemonThread::cmd_type, "MODE", &FTPDaemonThread::cmd_mode, "RNFR",
        &FTPDaemonThread::cmd_rnfr, "RNTO", &FTPDaemonThread::cmd_rnto, "MKD", &FTPDaemonThread::cmd_mkd, "XMKD",
        &FTPDaemonThread::cmd_mkd, "RMD", &FTPDaemonThread::cmd_rmd, "XRMD", &FTPDaemonThread::cmd_rmd, "DELE",
        &FTPDaemonThread::cmd_dele, "SIZE", &FTPDaemonThread::cmd_size, "PASV", &FTPDaemonThread::cmd_pasv, "MLST",
        &FTPDaemonThread::cmd_mlst, "MLSD", &FTPDaemonThread::cmd_mlsd, "FEAT", &FTPDaemonThread::cmd_feat,
        NULL };
