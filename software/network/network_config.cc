...
struct t_cfg_definition network_config[] = {
    ...
    { CFG_NETWORK_ULTIMATE_IDENT_SERVICE, CFG_TYPE_ENUM,"Ultimate Ident Service",           "%s", en_dis,     0,  1, 0 },
    { CFG_NETWORK_ULTIMATE_DMA_SERVICE, CFG_TYPE_ENUM,  "Ultimate DMA Service",             "%s", en_dis,     0,  1, 0 },
    { CFG_NETWORK_TELNET_SERVICE,   CFG_TYPE_ENUM,      "Telnet Remote Menu Service",       "%s", en_dis,     0,  1, 0 },
    { CFG_NETWORK_FTP_SERVICE,      CFG_TYPE_ENUM,      "FTP File Service",                 "%s", en_dis,     0,  1, 0 },
    { CFG_NETWORK_HTTP_SERVICE,     CFG_TYPE_ENUM,      "Web Remote Control Service",       "%s", en_dis,     0,  1, 0 },
