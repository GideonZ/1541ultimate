...
#define U2PIO_GET_MDIO (*(volatile uint8_t *)(U2P_IO_BASE + 0x04))
...
#define REMOTE_FLASHSEL_0   (*(volatile uint8_t *)(REMOTE_BASE + 0x0A))
#define REMOTE_FLASHSEL_1   (*(volatile uint8_t *)(REMOTE_BASE + 0x0B))
#define REMOTE_FLASHSELCK_0 (*(volatile uint8_t *)(REMOTE_BASE + 0x08))
#define REMOTE_FLASHSELCK_1 (*(volatile uint8_t *)(REMOTE_BASE + 0x09))
#define REMOTE_READ_PARAM   (*(volatile uint8_t *)(REMOTE_BASE + 0x04))
