...
#ifndef WANT_SMALL_STDIO /* ALTERA SMALL STDIO */	/* AlteraSpecific */
# define _REENT_SMALL_CHECK_INIT(ptr)		\
  ...
  while (0)
#else							/* AlteraSpecific */
# define _REENT_SMALL_CHECK_INIT(ptr) /* nothing */	/* AlteraSpecific */
...
#ifdef WANT_SMALL_STDIO /* ALTERA SMALL STDIO */ /* AlteraSpecific */
...
# ifdef WANT_SMALL_STDIO /* ALTERA SMALL STDIO */ /* AlteraSpecific */
typedef struct __sFILE_small_file    __FILE;
...
struct _reent
{
  ...
  /* see comments about WANT_SMALL_STDIO in local.c *//* AlteraSpecific */
...
#ifdef WANT_SMALL_STDIO				/* AlteraSpecific */
  struct __sFILE_small_file __sf_fake[3];	/* AlteraSpecific */
#else /* !WANT_SMALL_STDIO */			/* AlteraSpecific */
...
#ifdef WANT_SMALL_STDIO			/* AlteraSpecific -- entire section */

#define _REENT_INIT(var) \
  { 0, (__FILE *)&var.__sf_fake[0], (__FILE *)&var.__sf_fake[1], \
    (__FILE *)&var.__sf_fake[2], \
    _NULL, 0, 0, _NULL, _NULL, _NULL, _NULL, _NULL, \
    _NULL, \
    {_NULL, 0, {_NULL}, _NULL}, \
