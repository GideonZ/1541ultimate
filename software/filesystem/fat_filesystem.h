...
public:
    ...
    FRESULT get_free (uint32_t *e) { *e = 0; return FR_OK; } // Get number of free sectors on the file system
    bool is_writable() { return false; } // by default a file system is not writable, unless we implement it
    FRESULT sync(void) { return FR_OK; } // by default we can't write, and syncing is thus always successful
