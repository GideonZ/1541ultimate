...
const BYTE keymap_normal[] = {
    0x14,0x0D,0x1D,0x88,0x85,0x86,0x87,0x11, // BS, RET, Right, F7, F1, F3, F5, Down
...
Keyboard_C64 :: Keyboard_C64(GenericHost *h, volatile BYTE *row, volatile BYTE *col)
{
    host = h;
    col_register = col;
    row_register = row;
