...
#define MPS_PRINTER_BITMAP_SIZE_BW          (((MPS_PRINTER_PAGE_WIDTH*MPS_PRINTER_PAGE_HEIGHT*MPS_PRINTER_PAGE_DEPTH+7)>>3)+MPS_PRINTER_PAGE_HEIGHT)
#define MPS_PRINTER_BITMAP_SIZE_COLOR       (((MPS_PRINTER_PAGE_WIDTH*MPS_PRINTER_PAGE_HEIGHT*MPS_PRINTER_PAGE_DEPTH_COLOR+7)>>3)+MPS_PRINTER_PAGE_HEIGHT)
...
#define MPS_PRINTER_MAX_MARGIN_RIGHT        (MPS_PRINTER_PAGE_PRINTABLE_WIDTH - 1)
#define MPS_PRINTER_MAX_MARGIN_BOTTOM       (MPS_PRINTER_PAGE_PRINTABLE_HEIGHT - MPS_PRINTER_HEAD_HEIGHT - 1)
