...
void vPortSysTickHandler(void * context)
{
	...
	/* Clear the interrupt. */
	IOWR_ALTERA_AVALON_TIMER_STATUS( CPU_TIMER_BASE, ~ALTERA_AVALON_TIMER_STATUS_TO_MSK );
}
/*-----------------------------------------------------------*/
...
void prvSetupTimerInterrupt( void )
{
	...
	else
	{
		...
		IOWR_ALTERA_AVALON_TIMER_CONTROL( CPU_TIMER_BASE, ALTERA_AVALON_TIMER_CONTROL_STOP_MSK );
		IOWR_ALTERA_AVALON_TIMER_PERIODL( CPU_TIMER_BASE, ( configCPU_CLOCK_HZ / configTICK_RATE_HZ ) & 0xFFFF );
		IOWR_ALTERA_AVALON_TIMER_PERIODH( CPU_TIMER_BASE, ( configCPU_CLOCK_HZ / configTICK_RATE_HZ ) >> 16 );
		IOWR_ALTERA_AVALON_TIMER_CONTROL( CPU_TIMER_BASE, ALTERA_AVALON_TIMER_CONTROL_CONT_MSK | ALTERA_AVALON_TIMER_CONTROL_START_MSK | ALTERA_AVALON_TIMER_CONTROL_ITO_MSK );
	}
