...
#define GPIO_LED  GPIO_NUM_6

#define PIN_UART_RXD 20
#define PIN_UART_TXD 21
#define PIN_UART_RTS 4
#define PIN_UART_CTS 5
#define PIN_JTAG_TCK 8
#define PIN_JTAG_TMS 0
#define PIN_JTAG_TDI 1
...
void app_main()
{
    ...
    gpio_iomux_out(GPIO_LED, FUNC_MTCK_GPIO6, false);
